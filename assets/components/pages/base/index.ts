export { default as BaseBooksView } from './BaseBooksView.vue';
export { default as BaseBooksTableView } from './BaseBooksTableView.vue';
export { default as BasePublishersTableView } from './BasePublishersTableView.vue';
